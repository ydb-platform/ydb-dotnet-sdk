...
internal class AppContext
{
    ...
    internal AppContext(ILogger<AppContext> logger, CmdOptions cmdOptions)
    {
        ...
        _ydbDataSource = new YdbDataSource(cmdOptions.SimpleConnectionString);
    }
    ...
    {
        await using var ydbConnection = await _ydbDataSource.OpenRetryableConnectionAsync();
    ...
    {
        await using var ydbConnection = await _ydbDataSource.OpenConnectionAsync();
    ...
    private async Task SelectWithRetry()
    {
        await using var ydbConnection = await _ydbDataSource.OpenRetryableConnectionAsync();
