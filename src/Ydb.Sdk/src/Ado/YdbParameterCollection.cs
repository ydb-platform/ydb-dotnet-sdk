...
/// <summary>
///     Collects all parameters relevant to a <see cref="YdbCommand" /> as well as their respective mappings to DataSet
///     columns.
...
public sealed class YdbParameterCollection : DbParameterCollection, IList<YdbParameter>
{
    ...
    protected override void SetParameter(string parameterName, DbParameter value)
    {
        ...
        if (index == -1) throw new ArgumentException("Parameter not found");
