...
public sealed class YdbTableDescription
{
    ...
    ///     You can set additional properties like <see cref="Type" /> and <see cref="Indexes" /> using object initializer
    ///     syntax.
    /// </remarks>
    ...
    /// </summary>
    /// <value>
    ///     The table statistics including row count estimates and storage size, or <c>null</c> if statistics were not
    ///     requested.
    /// </value>
    /// <remarks>
    ///     This property is populated when describing a table with <see cref="DescribeTableSettings.IncludeTableStats" /> set
    ///     to <c>true</c>.
    /// </remarks>
