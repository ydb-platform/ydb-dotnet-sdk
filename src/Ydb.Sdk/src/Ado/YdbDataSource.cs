...
public class YdbDataSource : DbDataSource
{
    ...
    {
        if (disposing) DisposeAsyncCore().AsTask().GetAwaiter().GetResult();
    }
    ...
    /// <summary>
    ///     Executes an operation with a custom <see cref="YdbRetryPolicyConfig" />, cancellation token support and returns a
    ///     result.
    /// </summary>
    /// <typeparam name="TResult">The type of the result returned by the operation.</typeparam>
    /// <param name="func">The operation to execute with a <see cref="YdbConnection" /> and cancellation token.</param>
    ...
    /// <summary>
    ///     Executes an operation within a transaction with a custom <see cref="YdbRetryPolicyConfig" /> and cancellation token
    ///     support.
    /// </summary>
    /// <param name="func">The operation to execute within the transaction with cancellation token support.</param>
    /// <param name="retryPolicyConfig">The <see cref="YdbRetryPolicyConfig" /> to use for this operation.</param>
    ...
    /// <returns>A task representing the asynchronous operation.</returns>
    /// <remarks>
    ///     Executes the provided function within a transaction with the specified <see cref="YdbRetryPolicyConfig" /> and
    ...
    /// <summary>
    ///     Executes an operation within a transaction with a custom <see cref="YdbRetryPolicyConfig" />, cancellation token
    ///     support and returns a result.
    /// </summary>
    /// <typeparam name="TResult">The type of the result returned by the operation.</typeparam>
    /// <param name="func">The operation to execute within the transaction with cancellation token support.</param>
    /// <param name="retryPolicyConfig">The <see cref="YdbRetryPolicyConfig" /> to use for this operation.</param>
    ...
    /// <returns>A task representing the asynchronous operation.</returns>
    /// <remarks>
    ///     Executes the provided function within a transaction with the specified custom retry policy and cancellation
    ///     support.
    ///     The transaction is automatically committed on success or rolled back on failure.
    ///     The connection and transaction are automatically managed and disposed.
    /// </remarks>
    ...
    /// <summary>
    ///     Executes an operation within a transaction with a custom retry policy, cancellation token support and returns a
    ///     result.
    /// </summary>
    /// <typeparam name="TResult">The type of the result returned by the operation.</typeparam>
    /// <param name="func">The operation to execute within the transaction with cancellation token support.</param>
    ...
    ///     </para>
    ///     <para>
    ///         - On large result sets, these connections may cause <see cref="OutOfMemoryException" /> as they read all data
    ///         into memory. Use with caution.
    ///     </para>
    /// </remarks>
    ...
    /// <summary>
    ///     Asynchronously creates and opens a new <see cref="YdbConnection" /> with a custom
    ///     <see cref="YdbRetryPolicyConfig" />.
    /// </summary>
    ...
    ///     Thrown when the source table does not exist, destination already exists, or the
    ///     operation fails.
    /// </exception>
    ...
    /// </summary>
    /// <param name="copyTableSettingsList">
    ///     A list of copy table settings specifying source and destination tables for each
    ///     copy operation.
    /// </param>
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    /// <exception cref="YdbException">
    ///     Thrown when any source table does not exist, any destination already exists, or the
    ///     operation fails.
    /// </exception>
    ...
    /// </summary>
    /// <param name="renameTableSettingsList">
    ///     A list of rename table settings specifying source and destination names for each
    ///     rename operation.
    /// </param>
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    /// <exception cref="YdbException">
    ///     Thrown when any source table does not exist, any destination already exists (unless
    ///     ReplaceDestination is true), or the operation fails.
    /// </exception>
    ...
    /// </summary>
    /// <param name="tableDescription">
    ///     The table description containing columns, primary key, indexes, and other table
    ///     properties.
    /// </param>
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    ...
    ///     Thrown when attempting to create an External table type (not supported via
    ///     Control Plane RPC).
    /// </exception>
