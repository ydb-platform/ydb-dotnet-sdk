...
internal interface IYdbConnectionState
{
    ...
    IAsyncEnumerator<ExecuteQueryPart> ExecuteQuery(string query, Dictionary<string, YdbValue>? parameters);
...
internal sealed class OutTransactionState : IYdbConnectionState
{
    ...
    public OutTransactionState(YdbDataSource ydbDataSource)
    {
    ...
    public IAsyncEnumerator<ExecuteQueryPart> ExecuteQuery(string query, Dictionary<string, YdbValue>? parameters)
    {
