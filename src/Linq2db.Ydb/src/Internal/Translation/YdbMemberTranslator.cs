...
namespace LinqToDB.Internal.DataProvider.Ydb.Internal.Translation
{
	public class YdbMemberTranslator : ProviderMemberTranslatorDefault
	{
		...
		protected class StringMemberTranslator : StringMemberTranslatorBase
		{
			...
			protected Expression? TranslateLike(ITranslationContext translationContext, MethodCallExpression methodCall, TranslationFlags translationFlags)
			{
				var factory = translationContext.ExpressionFactory;
